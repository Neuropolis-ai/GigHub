          ...
          <div className="container mx-auto px-6">
            <div className="flex items-center justify-between h-16">
              <Link href="/" className="flex items-center space-x-2">
                ...
                <span className="text-xl font-bold gradient-text">GigHub</span>
              </Link>
              
              <div className="hidden md:flex items-center space-x-8">
                <Link href="/" className="link-hover text-gray-700 hover:text-blue-600">
                  Главная
                </Link>
                <Link href="/categories" className="link-hover text-gray-700 hover:text-blue-600">
                  Категории
                </Link>
                <Link href="/ai-services" className="link-hover text-gray-700 hover:text-blue-600">
                  ИИ-Сервисы
                </Link>
              </div>
              
              <div className="flex items-center space-x-4">
                <Link href="/ai-services" className="btn-primary text-sm px-4 py-2">
                  Исследовать
                </Link>
              </div>
            </div>
        ...
        <footer className="bg-gray-900 text-white">
          <div className="container mx-auto px-6 py-12">
            <div className="grid md:grid-cols-4 gap-8">
              <div className="col-span-2">
                ...
                <p className="text-gray-400 mb-4 max-w-md">
                  ...
                  Откройте для себя тысячи сервисов для любых задач.
                </p>
              ...
              <div>
                ...
                <ul className="space-y-2">
                  ...
                  <li><Link href="/categories" className="text-gray-400 hover:text-white transition-colors">Категории</Link></li>
                  <li><Link href="/ai-services" className="text-gray-400 hover:text-white transition-colors">ИИ-Сервисы</Link></li>
                </ul>
              </div>
            ...
            <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
              <p>&copy; 2024 GigHub. Все права защищены.</p>
            </div>
          </div>
        </footer>
      </body>
