...
export default function ServiceCardList({ 
  ...
  return (
    <div className="group bg-white rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-200 hover:border-accent-primary/30 p-6 transform hover:scale-105">
