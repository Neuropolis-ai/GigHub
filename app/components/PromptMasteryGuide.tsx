      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
        ...
        <div className="space-y-3">
          ...
          <select 
            ...
            className="w-full p-4 border-2 border-accent-secondary/20 rounded-xl focus:outline-none focus:ring-1 focus:ring-accent-secondary/30 focus:border-accent-secondary bg-white/90 backdrop-blur-sm shadow-sm hover:shadow-sm transition-all duration-300 font-medium text-text-primary hover:border-accent-secondary/40 appearance-none cursor-pointer"
            style={{
