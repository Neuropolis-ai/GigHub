...
const gradientMapping = {
  ...
  'mobile': 'from-fuchsia-500 to-purple-500',
  ...
  'ai': 'from-purple-400 to-violet-400'
}
...
function getIconForCategory(categoryName, slug) {
  ...
  if (name.includes('текст') || name.includes('письм')) return FileText
  if (name.includes('данн') || name.includes('аналит')) return BarChart
  ...
  if (name.includes('образован') || name.includes('обучен')) return BookOpen
...
function getGradientForCategory(categoryName, slug) {
  ...
  if (name.includes('изображен') || name.includes('картин') || name.includes('фото')) return 'from-purple-500 to-pink-500'
  ...
  if (name.includes('автомат') || name.includes('workflow')) return 'from-yellow-500 to-amber-500'
  if (name.includes('текст') || name.includes('письм')) return 'from-indigo-500 to-purple-500'
  ...
  if (name.includes('образован') || name.includes('обучен')) return 'from-orange-500 to-red-500'
  if (name.includes('социальн')) return 'from-emerald-500 to-teal-500'
  if (name.includes('безопасн')) return 'from-gray-500 to-slate-500'
  if (name.includes('мобильн')) return 'from-fuchsia-500 to-purple-500'
      ...
      <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-blue-50">
        <div className="container mx-auto px-6 py-24">
          <div className="text-center">
            <div className="w-16 h-16 border-4 border-purple-500 border-t-transparent rounded-full mx-auto mb-6 animate-spin"></div>
        ...
        <div className="container mx-auto px-6 py-24">
          <div className="text-center max-w-md mx-auto">
            ...
            <button 
              ...
              className="px-8 py-4 bg-purple-500 text-white rounded-xl font-medium hover:bg-purple-600 transition-colors shadow-lg hover:shadow-xl"
            >
              Попробовать снова
            </button>
          </div>
          ...
          <div className="relative container mx-auto px-6 py-16">
            <div className="text-center max-w-5xl mx-auto">
              <div className="flex items-center justify-center gap-2 mb-6">
                ...
                <span className="text-purple-500 font-semibold">Категории ИИ</span>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link href="/ai-services" className="inline-flex items-center px-8 py-4 bg-purple-500 text-white rounded-xl hover:bg-purple-600 transition-colors font-semibold shadow-lg hover:shadow-xl">
                ...
                return (
                  ...
                  >
                    <Link href={`/ai-services?category=${category.slug || category.id}`}>
                      <div className="relative overflow-hidden rounded-3xl bg-white border border-gray-200 hover:border-purple-300 shadow-lg hover:shadow-2xl transition-all duration-300 p-6 h-full cursor-pointer min-h-[220px] hover:scale-105 hover:-translate-y-2">
                        ...
                        <div className="relative z-10 flex flex-col h-full">
                          ...
                          <div className="flex-1">
                            <h3 className="text-xl font-bold text-text-primary mb-3 group-hover:text-purple-600 transition-colors line-clamp-2 leading-tight">
                              {category.name}
                            </h3>
                          ...
                          <div className="flex items-center justify-between mt-auto pt-4 border-t border-gray-100">
                            ...
                            <div className="w-10 h-10 rounded-full bg-purple-100 flex items-center justify-center group-hover:bg-purple-500 transition-all duration-300">
                              <ArrowRight className="w-4 h-4 text-purple-500 group-hover:text-white transition-colors" />
                            </div>
                          </div>
                        </div>
                      </div>
          ...
          <div className="container mx-auto px-6 text-center">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-4xl font-bold text-text-primary mb-6">
                Не нашли нужную <span className="text-purple-500">категорию</span>?
              </h2>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Link href="/ai-services?search=" className="inline-flex items-center px-8 py-4 border-2 border-purple-500 text-purple-500 rounded-xl hover:bg-purple-500 hover:text-white transition-colors font-semibold">
